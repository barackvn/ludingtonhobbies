    ...
    def create_xls(self, datas=None, cellutil=None):
        ...
        for record in records:
            try:
                ...
                out_file_name = safe_eval("pytz.utc.localize(datetime.now(), is_dst=None).astimezone(tz).replace(tzinfo=None).strftime(f_name)",{'obj': record, 'time': time, 'datetime': datetime, 'f_name': f_name, 'pytz':pytz, 'tz':tz})
                break
            except:
